...
public class OrderTests extends BaseTest {
    ...
    private static final String VALID_INGREDIENT_ID = "61c0c5a71d1f82001bdaaa73";
    ...
    @Ignore //Нет проверки авторизации по этой ручке на стороне сервиса, возвращает 200
    @Test
